...
class Aksesroot extends CI_Controller {
	...
	function index()
	{
		$session=isset($_SESSION['admin_toko_anda']) ? $_SESSION['admin_toko_anda']:'';
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				$data["judul"] = "Dashboard - Nama Toko Online Anda";
	...
	function set_akun()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				$data["judul"] = "Pengaturan Akun Admin - Nama Toko Online Anda";
	...
	function set_banner()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Pengaturan Banner - Nama Toko Online Anda";
	...
	function tambah_admin()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				$data["judul"] = "Tambah Admin - Nama Toko Online Anda";
	...
	function lihat_semua_member()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Member - Nama Toko Online Anda";
	...
	function lihat_semua_testimonial()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Testimonial - Nama Toko Online Anda";
	...
	function lihat_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Produk - Nama Toko Online Anda";
	...
	function lihat_semua_intermezzo()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Intermezzo - Nama Toko Online Anda";
	...
	function transaksi_harian()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Transaksi Harian - Nama Toko Online Anda";
	...
	function transaksi_bulanan()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Transaksi Bulanan - Nama Toko Online Anda";
				$data["tampil"] = $this->sandal_admin_model->tampil_trans_harian($data['kata'],$limit,$offset);
				$tot_hal = $this->sandal_model->hitung_isi_1tabel('tbl_transaksi_detail',"where kode_transaksi like '%".$data['kata']."%'");
	...
	function transaksi_tahunan()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Transaksi Tahunan - Nama Toko Online Anda";
				$data["tampil"] = $this->sandal_admin_model->tampil_trans_harian($data['kata'],$limit,$offset);
				$tot_hal = $this->sandal_model->hitung_isi_1tabel('tbl_transaksi_detail',"where kode_transaksi like '%".$data['kata']."%'");
	...
	function lihat_kategori_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				$data["judul"] = "Semua Kategori Produk - Nama Toko Online Anda";
	...
	function lihat_katalog()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Semua Katalog Produk - Nama Toko Online Anda";
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				if ($_FILES['imagefile']['type'] == "image/jpeg"){
					...
					values('".$kode."','".$kategori."','".$nama."','".$harga."','".$stok."','".$dibeli."','".strtolower( str_replace(' ','_',$_FILES['imagefile']['name'])."'
					,'".strtolower( str_replace(' ','_',$_FILES['imagefile']['name'])."','".$deskripsi."','".$tipe."')");
...
//=======================Modul Tambah======================//
	...
	function tambah_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Tambah Produk - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function tambah_kategori_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
	   			$data['scriptmce'] = $this->scripttiny_mce();
				$data["kat"] = $this->sandal_admin_model->tampil_semua_kategori();
				$data["judul"] = "Tambah Kategori Produk - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function tambah_katalog()
	{
		...
		if($session!=""){
			...
			{
	   			$data['scriptmce'] = $this->scripttiny_mce();
				$data["judul"] = "Tambah Katalog Produk - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function tambah_intermezzo()
	{
		...
		if($session!=""){
			...
			{
	   			$data['scriptmce'] = $this->scripttiny_mce();
				$data["judul"] = "Tambah Intermezzo - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_produk()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["kat"] = $this->sandal_admin_model->tampil_semua_kategori();
				$data["judul"] = "Edit Produk - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_banner()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Banner - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_katalog()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Katalog - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_member()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Member - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_testi()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Testimonial - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
	...
	function edit_intermezzo()
	{
		...
		if($session!=""){
			...
			if($data["lvl"]=="spradmn")
			{
				...
				$data["judul"] = "Edit Intermezzo - Nama Toko Online Anda";
				$this->load->view('admin/bg_top',$data);
		...
		else
		{
			if (!ctype_alnum($username) OR !ctype_alnum($pwd)){
				...
				if (count($hasil->result_array())>0){
					...
					$_SESSION['admin_toko_anda']=$session_username;
					echo "<meta http-equiv='refresh' content='0; url=".base_url()."aksesroot'>";
				}
				else{
					?>
