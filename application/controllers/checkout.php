...
class Checkout extends CI_Controller {
	...
	function index()
	{
		...
		if($session!="")
		{
			...
			$data['judul'] = "Selesai Belanja - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
	...
	function kirim_invoice()
	{
		...
		if($session==""){
			...
			$data["email"]=$pecah[3];
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Kirim Pesanan - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(3);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
			...
			$data['pesan'] = "";
				...
				{
					$isi_psn = 'Terima kasih telah berbelanja di Nama Toko Online Anda. Berikut detail produk yang anda beli :<br><br>
...
';
					...
					$isi_psn .='Salam, Nama Toko Online Anda';
