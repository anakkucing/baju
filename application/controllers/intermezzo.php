...
class Intermezzo extends CI_Controller {
	...
	function cari()
	{
		...
		$data['judul'] = "Intermezzo - Tips dan Trik - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
	...
	function baca()
	{
		...
		$data['menu'] = $this->sandal_model->menu_kategori('0','0');
		$data['judul'] = $data['baca']."- Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
		$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
		$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(3);
		$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
		$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
