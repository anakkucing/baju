...
class Konfirmasi extends CI_Controller {
	...
	function index()
	{
		...
		$data['judul'] = "Konfirmasi Pembayaran - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
	...
	{
		$data['menu'] = $this->sandal_model->menu_kategori('0','0');
		$data['judul'] = "Hubungi Kami - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
		$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
		$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(3);
		$data['slide_produk_home'] = $this->sandal_model->tampil_produk(12);
		$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
