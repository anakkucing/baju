...
class Member extends CI_Controller {
	...
	function index()
	{
		...
		if($session!=""){
			...
			$data['judul'] = "Member Area - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
			...
			$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
	...
	function login()
	{
		...
		if($session!=""){
			...
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Log In Member - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(3);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
	...
	function daftar()
	{
		...
		if($session!=""){
			...
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Register Member - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(3);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
		...
		if($session!=""){
			...
			else
			{
					...
					if (count($q->result())>0){
						...
						$this->email->from("admin@harmonisgrosirsandal.com", "Admin Nama Toko Online Anda");
						$this->email->to($datapesan['email']);
						
						$this->email->set_mailtype('html');
						$this->email->subject('Aktivasi Keanggotaan - Nama Toko Online Anda');
	...
	function lupa()
	{
		...
		if($session==""){
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Lupa Password - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(3);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
	...
	function update_reset_pass()
	{
		...
		if($session!=""){
			...
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "Set Password - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(3);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
	...
	function history()
	{
		...
		if($session==""){
			...
			$data["kd_user"]=$pecah[2];
			$data['menu'] = $this->sandal_model->menu_kategori('0','0');
			$data['judul'] = "History Transaksi - Nama Toko Online Anda, Nama Toko Online Anda Termurah dan Terlengkap di Indonesia - Nama Toko Online Anda";
			$data['slide_atas'] = $this->sandal_model->tampil_slide_produk(10);
			$data['slide_laris'] = $this->sandal_model->tampil_slide_produk_terlaris_kiri(3);
			$data['slide_baru'] = $this->sandal_model->tampil_produk(3);
			$data['slide_rekomendasi'] = $this->sandal_model->tampil_slide_produk(6);
