...
<table width="100%" border="1" cellspacing="0">
	...
	{
	echo '<tr><td width="120" style="padding:5px;">'.$tp['kode_produk'].'</td><td style="padding:5px;">'.$tp['nama_produk'].'</td><td style="padding:5px;">'.$tp['nama_kategori'].'</td><td style="padding:5px;">'.$tp['stok'].'</td><td style="padding:5px;">'.$tp['harga'].'</td><td style="padding:5px;">'.$tp['tipe_produk'].'</td><td style="padding:5px;"><a href="'.base_url().'aksesroot/edit_produk/'.$tp['kode_produk'].'"><img src="'.base_url().'asset/admin/images/edit-icon.gif" border=0> Edit</a></td><td style="padding:5px;"><a href="'.base_url().'aksesroot/hapus_produk/'.$tp['kode_produk'].'/'.$tp['gbr_kecil'].'" onClick=\'return confirm("Anda yakin ingin menghapus konten ini???")\'><img src="'.base_url().'asset/admin/images/hapus.png" border=0> Hapus</a></td></tr>';
	}
	?>
</table>
