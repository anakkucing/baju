...
<table width="100%" border="1" cellspacing="0">
	...
	echo '<tr><td width="120" style="padding:5px;">MHGS-'.$tp['kode_user'].'</td><td style="padding:5px;">'.$tp['nama'].'</td><td style="padding:5px;">'.$tp['username_user'].'</td><td style="padding:5px;">'.$tp['email'].'</td><td style="padding:5px;">'.$tp['telpon'].'</td><td style="padding:5px;">'.$st.'</td><td style="padding:5px;"><a href="'.base_url().'aksesroot/edit_member/'.$tp['kode_user'].'"><img src="'.base_url().'asset/admin/images/edit-icon.gif" border=0> Edit</a></td><td style="padding:5px;"><a href="'.base_url().'aksesroot/hapus_member/'.$tp['kode_user'].'" onClick=\'return confirm("Anda yakin ingin menghapus konten ini???")\'><img src="'.base_url().'asset/admin/images/hapus.png" border=0> Hapus</a></td></tr>';
	}
	?>
</table>
