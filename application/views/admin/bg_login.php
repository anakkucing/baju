...
<link href="<?php echo base_url(); ?>asset/admin/css/style-login.css" rel="stylesheet" type="text/css" />
</head>
...
<div id="bg-login">
<div id="judul"><img src="<?php echo base_url(); ?>asset/admin/images/logo-login.png" /></div>
...
<div id="judul"><br />Administrator Nama Toko Online Anda - <?php echo date('Y'); ?></div>
</div>
</form>
</body>
</html>
