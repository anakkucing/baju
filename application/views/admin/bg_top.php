...
<title>Administrator Nama Toko Online Anda</title>
<link rel="stylesheet" href="<?php echo base_url(); ?>asset/admin/css/screen.css" type="text/css" media="screen" title="default" />
<script type="text/javascript" src="<?php echo base_url(); ?>asset/admin/js/jquery-1.4.js" ></script>
</head>
<body onload="goforit();"> 
...
<div id="page-top">
	...
	<div id="logo">
	<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>asset/admin/images/logo-login.png" height="70" alt="" border="0" /></a>
	</div>
	<div style="float:right; padding-top:70px; color:#FFFFFF; padding-right:30px;">
	<?php
		echo "Selamat Datang, <b>".$nama."</b>. | ";
	?><script src="<?php echo base_url(); ?>asset/admin/js/clock.js" type="text/javascript"></script><span id="clock"></span>
	</div>
