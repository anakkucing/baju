...
<link href="<?php echo base_url(); ?>asset/css/material-design.css" rel="stylesheet">
...
<header>
		<div class="container">
			...
			<div class="fright">
				<div class="phone">
					<i class="material-icons-local_phone"></i>9999 8888 7777
				</div>
			</div>
		</div>
		<div class="container">
			...
			<div class="fright">
				<div class="box-cart">
					...
					<button type="button" data-loading-text="Loading..." class="toggle item-btn">
						...
						<span id="cart-total2" class="cart-total2">0 items</span> <span id="cart-total3" class="cart-total3">0</span> 
					</button>
